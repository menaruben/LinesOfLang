...
## Documentation
NOTE: It is recommended to add [lol.py](./src/lol.py) to your path with a short name like "lol" or go to releases tab and install the executable. I did this for the documentation. So please keep that in mind.
